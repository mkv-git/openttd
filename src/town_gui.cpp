/* $Id: town_gui.cpp 26460 2014-04-13 10:47:39Z frosch $ */
...
public:
	...
	virtual void DrawWidget(const Rect &r, int widget) const
	{
		...
		if (HasBit(this->town->flags, TOWN_IS_GROWING)) {
			SetDParam(0, ((this->town->growth_rate & (~TOWN_GROW_RATE_CUSTOM)) * TOWN_GROWTH_TICKS + (DAY_TICKS / COST_MULTIPLIER)) / (DAY_TICKS / COST_MULTIPLIER));
